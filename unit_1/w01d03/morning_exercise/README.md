...
:star: Use **tab** to autocomplete a file or folder name by begining to type it out.  If it's not autocompleting, you may be in the wrong directory!
...
1. Create a folder on your desktop called `deleteme_w01d02`.
    ...
    - `mkdir deleteme_w01d02`
2. Inside `deleteme_w01d02`, create a file `testing.html`.  
    - `cd deleteme_w01d02` **Tab it** only type `cd de` and then press tab
    - `touch testing.html`
...
- Click on Atom, and then click on `Install Shell Commands`. _Nothing will happen when you complete these steps._

![install shell commands](https://i.imgur.com/XogSUs3.png)

- You will need to quit terminal _and_ atom (`cmd` + `q`) in order for this to take effect.  
...
### Then how do I know it worked?
 ...
 1. Navigate back into your `deleteme_w01d02` directory.
...
![Atom - Split Pane Dropdown](https://i.imgur.com/1tTgzLD.png) <br>
