...
- Reach out to each other on slack! 
- During labs, maybe take a few minutes in the beginning to just talk to each other, get to know each other!
...
For more [tips and tricks,](https://git.generalassemb.ly/Web-Development-Immersive-Remote/WDIR-Outrun/wiki/Tips-and-Tricks) feel free to reference this document that has been compiled by Matt Huntington (GA WDIR Instructor)
