...
- We've been covering a lot of things with a lot of little details. No need to memorize, [just keep this cheatsheet handy](https://git.generalassemb.ly/Web-Development-Immersive-Remote/WDIR-Outrun/wiki/JQuery-Cheatsheet-as-Tables)! or [this one](https://git.generalassemb.ly/Web-Development-Immersive-Remote/WDIR-Outrun/wiki/jQuery-Cheatsheet) - they have the same information but are formatted differently, use the one that is easier for you to read
