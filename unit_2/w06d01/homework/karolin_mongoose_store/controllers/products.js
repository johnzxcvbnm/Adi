...
products.get('/', (req, res) => {
  Product.find({}).sort({name: 1}).exec((err, allProducts) => {
    if (err) {
      res.send(err)
    } else {
...
products.get('/seed/newproducts', (req, res) => {
  ...
  [
    ...
    },
    {
      ...
      description: 'Bored of your neighborhood? Bored of your typical vacation? Go to the 5th dimension. Please note: shipping is unavailable at this time',
      price: 1,
      qty: 54
    }
  ]
