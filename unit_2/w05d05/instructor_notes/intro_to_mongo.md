...
```
### Drop a collection
**Note: do not run these commands yet if we have time to do bonus activity!**
...
```
We have a bunch of [query operators](https://docs.mongodb.com/manual/reference/operator/query/) - this will let us search for values greater than, less than, included in an array and many more.
