...
1. create an `App` class and pass that as the main element in ReactDOM.render()

1. move the `h1` element to a `div` inside the `App` render function
...
## Create a Furniture Class and Pass Props
